...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'category[score]' => 'Something New',
            'category[test_id]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getTest_id());
    }
